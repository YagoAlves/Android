 ...
 */
public class TelaMapa extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {

    //private TextView cordenada;
    ...
    public void onConnected(Bundle bundle){
        Toast.makeText(TelaMapa.this, "Conectado no Google Play Services!", Toast.LENGTH_SHORT).show();
    }

    public void onConnectionSuspended(int cause){
        Toast.makeText(TelaMapa.this, "Conexão interrompida", Toast.LENGTH_SHORT).show();
    }

    public void onConnectionFailed(ConnectionResult connectionResult){
        Toast.makeText(TelaMapa.this, "Erro ao conectar: " + connectionResult, Toast.LENGTH_SHORT).show();
    }
    ...
    private void setMapLocation(Location l){
        if(map != null && l != null){
            ...
            //cordenada.setText(-4.971241 + "|" + -39.01536);
